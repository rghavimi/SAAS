...
var app = Vue.createApp({
  ...
  methods: {
    createAdCopy: function createAdCopy() {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var url, requestBody, rawResponse, content;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                requestBody = JSON.stringify({
                  "prompt": _this.productDescription,
                  "temperature": 0.5,
                  "max_tokens": 60,
                  "top_p": 1.0,
              ...
              case 7:
                ...
                _this.response = content["choices"][0]["text"];
...
app.mount("#app"); // window.createAdCopy = async function(){
// };
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./assets/js/dashboard.js")))
